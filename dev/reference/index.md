...
- [`session_info()`](https://sessioninfo.r-lib.org/dev/reference/session_info.md)
  [`toLatex(`*`<session_info>`*`)`](https://sessioninfo.r-lib.org/dev/reference/session_info.md)
...
- [`package_info()`](https://sessioninfo.r-lib.org/dev/reference/package_info.md)
  : Information about the currently loaded packages, or about a chosen
  set
...
- [`os_name()`](https://sessioninfo.r-lib.org/dev/reference/os_name.md)
